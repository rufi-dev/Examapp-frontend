...
const ExamEdit = () => {
  ...
  return (
    <AccountLayout title="İmtahanı redaktə et" subtitle="İmtahan məlumatlarını yenilə.">
      <form onSubmit={editExamForm} className="space-y-6">
        <FormSection title="İmtahan məlumatı">
          <div className="grid gap-5 sm:grid-cols-2">
            <Field label="İmtahan adı" htmlFor="name" required className="sm:col-span-2">
              <input value={name} onChange={handleInputChange} type="text" name="name" id="name" className={inputClass} />
            </Field>
            <Field label="PDF fayl" htmlFor="pdf" hint="Dəyişmək üçün yeni fayl seçin" className="sm:col-span-2">
