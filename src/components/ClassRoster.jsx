...
// The approved students of a class, with add (searchable picker) + remove. Used
// by the class cards and by Siniflərim. `onChange` lets the parent refresh its
// member counts after an add/remove.
const ClassRoster = ({ classObj, label, onClose, onChange }) => {
